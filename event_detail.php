...
<html>
<head>
	<title>College Events - Event Detail/Search Event</title>
	<style>
		body{
...
<body>
	...
	<div class="top">
		<h1 style="color:#100054">COLLEGE EVENTS</h1>
	</div>
	<!--Search event form-->
		...
		<?php
			...
			if(mysqli_num_rows($result)>0){
    			...
    			while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
        			...
        			echo "<tr><td><span  style='font-size:25px';><hr>". $row['EventDescription']."</td></tr>";
        			echo "<tr>
        					<td>
        						<ul>
        							...
        							<li><b>Price: </b>".$row['EventTicketPrice']."</li>
