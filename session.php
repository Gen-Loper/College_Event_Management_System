...
if (isset($_SESSION['UserFullName'])!=null){
	echo "<b><p style='text-align:right;font-size:22px;color:black;'>Wel-Come, ".$_SESSION['UserFullName']." ! &nbsp;|&nbsp; <a href='index.php' >Home </a>";
	$login_status="yes";
	$uid=$_SESSION['UserID'];
	$utype=$_SESSION['UserType'];
	if($utype=='Admin'){
		echo "&nbsp;|&nbsp; <a href='admin_delete.php'>Admin Management</a>";
	...
	echo "<b><p style='text-align:right;font-size:22px;color:black;'>Welcome, Guest ! ";
